...
land = [[5 for _ in range(101)] for _ in range(101)]
nourishment = []
tree = [[[] for _ in range(101)] for _ in range(101)]
dead_tree = []
        ...
        for y in range(101):
            for i in range(len(tree[x][y])):
                if tree[x][y][i] % 5 == 0:
                    ...
                    if x - 1 >= 0 and y + 1 < 101: tree[x - 1][y + 1].append(1)
                    if y - 1 >= 0: tree[x][y - 1].append(1)
                    if y + 1 < 101: tree[x][y + 1].append(1)
                    if x + 1 < 101 and y - 1 >= 0: tree[x + 1][y - 1].append(1)
                    if x + 1 < 101: tree[x + 1][y].append(1)
                    if x + 1 < 101 and y + 1 < 101: tree[x + 1][y + 1].append(1)
...
for x in range(101):
    for y in range(101): answer += len(tree[x][y])
